...
# Инициализация DAG
dag = DAG(dag_id='upstream_dag_trigger', 
...
trigger_dependent_dag = TriggerDagRunOperator(
    ...
    trigger_dag_id="downstream_dag_trigger",
    dag=dag
)


get_kerberos_ticket >> python_task_1 >> trigger_dependent_dag >> [pyspark_task_1, pyspark_task_2]